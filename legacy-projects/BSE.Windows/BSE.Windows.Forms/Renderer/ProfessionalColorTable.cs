...
namespace BSE.Windows.Forms
{
    ...
    public class ProfessionalColorTable : System.Windows.Forms.ProfessionalColorTable
    {
        ...
        public enum KnownColors
        {
            ...
            /// <summary>
            /// The border color to use with ButtonPressedHighlight.
            /// </summary>
            ButtonPressedHighlightBorder,
            /// <summary>
            /// The text color of a button used when the button is pressed down.
            /// </summary>
            ButtonPressedText,
            /// <summary>
            ...
            /// ToolStripMenuItem is selected.
            /// </summary>
            MenuItemTopLevelPressedGradientBegin,
            /// <summary>
            /// The end color of the gradient used when a top-level
            /// ToolStripMenuItem is selected. 
            /// </summary>
            MenuItemTopLevelPressedGradientEnd,
            /// <summary>
            /// The middle color of the gradient used when a top-level
            /// ToolStripMenuItem is selected.
            /// </summary>
            MenuItemTopLevelPressedGradientMiddle,
            /// <summary>
        ...
        /// <summary>
        /// Gets the text color of a button used when the button is pressed down.
        /// </summary>
        public virtual Color ButtonPressedText
        {
            get
            {
                return this.FromKnownColor(KnownColors.ButtonPressedText);
            }
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets the color of the border used when a top-level ToolStripMenuItem is selected.
        /// </summary>
        public virtual Color MenuItemTopLevelPressedBorder
        {
            get
            {
                return this.FromKnownColor(KnownColors.MenuItemTopLevelPressedBorder);
            }
        }
        /// <summary>
        ...
        /// ToolStripMenuItem is selected.
        /// </summary>
        public virtual Color MenuItemTopLevelPressedGradientBegin
        {
            get
            {
                return this.FromKnownColor(KnownColors.MenuItemTopLevelPressedGradientBegin);
            }
        }
        /// <summary>
        /// Gets the end color of the gradient used when a top-level
        /// ToolStripMenuItem is selected.
        /// </summary>
        public virtual Color MenuItemTopLevelPressedGradientEnd
        {
            get
            {
                return this.FromKnownColor(KnownColors.MenuItemTopLevelPressedGradientEnd);
            }
        }
        /// <summary>
        /// Gets the middle color of the gradient used when a top-level
        /// ToolStripMenuItem is selected.
        /// </summary>
        public virtual Color MenuItemTopLevelPressedGradientMiddle
        {
            get
            {
                return this.FromKnownColor(KnownColors.MenuItemTopLevelPressedGradientMiddle);
            }
        }
        /// <summary>
		...
		private void InitBaseColors(Dictionary<KnownColors, Color> rgbTable)
		{
            ...
            rgbTable[KnownColors.ButtonPressedHighlightBorder] = base.ButtonPressedHighlightBorder;
            rgbTable[KnownColors.ButtonPressedText] = Color.FromArgb(0, 0, 0);
            ...
            rgbTable[KnownColors.CheckPressedBackground] = base.CheckPressedBackground;
            ...
            rgbTable[KnownColors.MenuItemTopLevelPressedBorder] = base.ButtonSelectedHighlightBorder;
            //rgbTable[KnownColors.MenuItemTopLevelBorder] = base.MenuItemBorder;
            ...
            rgbTable[KnownColors.MenuItemTopLevelPressedGradientBegin] = base.MenuItemPressedGradientBegin;
            rgbTable[KnownColors.MenuItemTopLevelPressedGradientEnd] = base.MenuItemPressedGradientEnd;
            rgbTable[KnownColors.MenuItemTopLevelPressedGradientMiddle] = base.MenuItemPressedGradientMiddle;
