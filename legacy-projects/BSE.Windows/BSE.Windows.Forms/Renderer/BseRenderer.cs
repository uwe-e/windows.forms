    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            else
            {
                ...
                if (LayoutUtils.IsZeroWidthOrHeight(buttonBounds) == true)
                {
                    return;
                }
                ...
                if (colorTable != null)
                {
                    using (UseAntiAlias antiAlias = new UseAntiAlias(graphics))
                    {
                        ...
                        if ((item.Selected == true) && (item.Pressed == false))
                        {
                            ...
                            RenderButton(graphics, buttonRectangle, colorTable.ButtonSelectedGradientBegin, colorTable.ButtonSelectedGradientEnd);
                        ...
                        if (item.Pressed == true)
                        {
                            ...
                            RenderButton(graphics, buttonRectangle, colorTable.MenuItemPressedGradientBegin, colorTable.MenuItemPressedGradientEnd);
                            ...
                            DrawInnerButtonBorder(graphics, buttonRectangle, colorTable.ButtonPressedHighlightBorder);
            ...
            if (colorTable != null)
            {
                using (UseAntiAlias useAntiAlias = new UseAntiAlias(graphics))
                {
                    if (e.ToolStrip is MenuStrip)
                    {
                        if ((item.Selected == true) && (item.Pressed == false))
                        {
                            RenderMenuItem(graphics, bounds, colorTable.MenuItemTopLevelSelectedGradientBegin, colorTable.MenuItemTopLevelSelectedGradientEnd);
                            ControlPaint.DrawBorder(e.Graphics, bounds, colorTable.MenuItemTopLevelSelectedBorder, ButtonBorderStyle.Solid);
                        }
                        if (item.Pressed == true)
                        {
                            RenderButton(graphics, bounds, colorTable.MenuItemTopLevelPressedGradientBegin, colorTable.MenuItemTopLevelPressedGradientEnd);
                            Rectangle innerBorderRectangle = bounds;
                            innerBorderRectangle.Inflate(-1, -1);
                            ControlPaint.DrawBorder(e.Graphics, innerBorderRectangle, colorTable.MenuItemTopLevelPressedBorder, ButtonBorderStyle.Solid);
        ...
        protected override void OnRenderStatusStripSizingGrip(ToolStripRenderEventArgs e)
        {
            ...
            if (toolStrip != null)
            {
                ...
                if (LayoutUtils.IsZeroWidthOrHeight(sizeGripBounds) == false)
                {
                ...
                if ((backgroundRectangle.Width > 0) && (backgroundRectangle.Height > 0))
                {
                    ...
                    else if (e.ToolStrip is MenuStrip)
                    {
                        ...
                        using (LinearGradientBrush innerRectangleBrush = new LinearGradientBrush(
                            ...
                            Color.FromArgb(128, ColorTable.MenuStripGradientBegin),
                            LinearGradientMode.Vertical))
                        {
                            e.Graphics.FillRectangle(innerRectangleBrush, lowerRectangle); //draw top bubble
                        }
        ...
        private static void RenderButton(Graphics graphics, Rectangle buttonBounds, Color gradientColor1, Color gradientColor2)
        {
            using (GraphicsPath graphicsPath = LayoutUtils.GetBackgroundPath(buttonBounds, 3))
            {
        ...
        private static void RenderMenuItem(Graphics graphics, Rectangle menuBounds, Color gradientColor1, Color gradientColor2)
        {
        ...
        {
            using (GraphicsPath itemPath = LayoutUtils.GetBackgroundPath(buttonBounds, 3))
            {
        ...
        private static void DrawInnerButtonBorder(Graphics graphics, Rectangle buttonBounds, Color innerBorderColor)
        {
            ...
            using (GraphicsPath innerBorderPath = LayoutUtils.GetBackgroundPath(innerButtonRectangle, 3))
            {
