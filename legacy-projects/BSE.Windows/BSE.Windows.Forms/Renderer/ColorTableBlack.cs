...
namespace BSE.Windows.Forms
{
    ...
    public class ColorTableBlack : BSE.Windows.Forms.BseColorTable
    {
        ...
        protected override void InitColors(Dictionary<ProfessionalColorTable.KnownColors, Color> rgbTable)
        {
            ...
            rgbTable[KnownColors.ButtonPressedHighlightBorder] = Color.FromArgb(145, 153, 164);

            rgbTable[KnownColors.ButtonSelectedGradientBegin] = Color.FromArgb(205, 208, 213);
            rgbTable[KnownColors.ButtonSelectedGradientEnd] = Color.FromArgb(0, 0, 0, 0);
            ...
            rgbTable[KnownColors.MenuItemPressedGradientEnd] = Color.FromArgb(0, 0, 0, 0);
            ...
            rgbTable[KnownColors.MenuItemTopLevelSelectedGradientEnd] = Color.FromArgb(0, 0, 0, 0);

            rgbTable[KnownColors.MenuItemTopLevelSelectedBorder] = Color.FromArgb(145, 153, 164);

            rgbTable[KnownColors.MenuItemTopLevelPressedGradientEnd] = Color.FromArgb(0, 0, 0, 0);

            rgbTable[KnownColors.MenuItemTopLevelPressedBorder] = Color.FromArgb(145, 153, 164);
