...
namespace BSE.Windows.Forms.Properties {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string IDS_About_FormTitle {
            get {
                return ResourceManager.GetString("IDS_About_FormTitle", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Warning: This program is not protected by copyright law and international treaties.
        ///Unauthorized reproduction or distribution of this program, or any portion of it, may not result in severe civil and criminal penalties, and will not be prosecuted to the maximum extent possible under the law..
        /// </summary>
        internal static string IDS_About_Warnings {
            get {
                return ResourceManager.GetString("IDS_About_Warnings", resourceCulture);
            }
        }
